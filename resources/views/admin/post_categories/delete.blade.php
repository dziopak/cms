...
@section('content-left')
    @wrapper('admin.partials.wrapper', ['title' => 'admin/post_categories.delete_top_title'])
    ...
    @wrapper('admin.partials.wrapper', ['title' => 'admin/post_categories.delete_bottom_title'])
