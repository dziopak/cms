...
@section('before')
    ...
    @include('admin.layouts.partials.controls')
    {!! Form::model($layout, ['method' => 'PATCH', 'action' => ['Admin\Modules\Layouts\LayoutsController@update', $layout->id], 'class' => 'w-100', 'id' => 'LayoutUpdateForm']) !!}
@endsection
