...
class CategoriesComposers extends ServiceProvider
{
    ...
    public function boot(Request $request)
    {
        view()->composer('admin.post_categories.index', function ($view) use ($request) {
            ...
            $view->table = getData('Admin/Modules/categories/post_categories_index_table');
        });
        ...
        view()->composer('admin.post_categories.create', function ($view) {
            ...
            $view->form = getData('Admin/Modules/categories/post_categories_form', ['categories' => $categories]);
        });
        ...
        view()->composer('admin.post_categories.edit', function ($view) {
            ...
            $view->form = getData('Admin/Modules/categories/post_categories_form', ['categories' => $view->categories]);
        });
        ...
        view()->composer('admin.page_categories.index', function ($view) use ($request) {
            ...
            $view->table = getData('Admin/Modules/categories/page_categories_index_table');
        });
        ...
        view()->composer('admin.page_categories.create', function ($view) {
            ...
            $view->form = getData('Admin/Modules/categories/page_categories_form', ['categories' => $categories]);
        });
