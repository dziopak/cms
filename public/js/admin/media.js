...
function _getResult() {
  _getResult = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
    var callback,
        _args3 = arguments;
...
function sendResult(blob, override) {
  resize.result('blob').then(function (blob) {
    ...
    var fd = new FormData();
    fd.append('data', blob);
    fd.append('type', 'blob'); // Override existing file
...
document.getElementById('save-image').onclick = /*#__PURE__*/function () {
...
document.getElementById('save-as').onclick = /*#__PURE__*/function () {
...
/***/ 3:
/*!*******************************************!*\
  !*** multi ./resources/js/admin/media.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\laragon\www\cms\resources\js\admin\media.js */"./resources/js/admin/media.js");
