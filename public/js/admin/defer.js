...
$(document).ready(function () {
  ...
  function axiosDelete(_x) {
    return _axiosDelete.apply(this, arguments);
  }

  function _axiosDelete() {
    _axiosDelete = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(route) {
      var callback,
          _args = arguments;
...
$('.add-button').click(function (e) {
  ...
  if (!list.find('.tag[data-id="' + select.val() + '"]').length > 0) {
    list.append("<div class=\"tag\" data-id=\"".concat(select.val(), "\">\n                <input type=\"hidden\" name=\"").concat($(this).data('for'), "[]\" value=\"").concat(select.val(), "\">\n                ").concat($(selector + ' option:selected').text(), "\n                <span class=\"close\">x</span>\n            </div>"));
  }
});
